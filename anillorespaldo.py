...
seed = Event("DESPIERTA", 0.0, 1, 1)
seed2 = Event("DESPIERTA", 0.0, 7, 7)
...
experiment.run()
            ...
            """print (f"{event.getName()[0]} {event.getName()[1]}")
            event.getName()[0] = "ELECTO"
            print(f"Ahora el event.getname es {event.getName()[0]}")
            ...
            self.transmit(newevent)
            print("Entre a candidato en getName")"""